...
class productos_model
{
	...
	{
		$query = "SELECT Estado FROM Pedidos WHERE Estado = 'Realizado' AND idUsuario = ?";
		...
		if ($resultado->num_rows > 0) {
			return true; // Hay un pedido con estado 'Realizado' para el usuario.
		} else {
			return false; // No se encontró ningún pedido con estado 'Realizado' para el usuario.
		}
	}
